            ...
            <form action="{{ route('admin.surat.store', $dataJenisSurat->slug) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Cth. Kartu Indonesia Sehat" name="jenis_surat" value="{{ old('jenis_surat') }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Cth. Nama Yang Tertera Pada Surat Tersebut" name="nama_yang_tertera" value="{{ old('nama_yang_tertera') }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Cth. Nomor Surat Tersebut" name="nomor_surat_tersebut" value="{{ old('nomor_surat_tersebut') }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="uploadFileSertifikat" name="file_surat" required>
