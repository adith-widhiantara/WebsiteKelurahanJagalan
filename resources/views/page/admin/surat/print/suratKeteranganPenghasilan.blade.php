...
<body>
    ...
    <table class="table" style="margin-left: 30px;">
        <tbody>
            ...
            <tr>
                <td>
                    <p style="font-size: 12px">Penghasilan</p>
                </td>
                <td>
                    <p style="font-size: 12px">: {{ $surat['self']['penghasilan'] }}</p>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <p style="font-size: 12px">: {{ $surat['self']['keperluan'] }}</p>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <p style="font-size: 12px">: {{ $surat['self']['keterangan'] }}</p>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table" style="width: 100%">
        <tbody>
            <tr>
                <td>
                    <img src="{{ $data['footer']['ttdblank'] }}" height="100">
                    <p style="font-size: 12px">{{ $surat['self']['nama'] }}</p>
                </td>
                <td>
                    <div style="float: right">
