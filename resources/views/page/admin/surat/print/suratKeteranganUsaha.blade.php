...
<body>
    ...
    <table class="table" style="margin-left: 30px;">
        <tbody>
            ...
            <tr>
                <td>
                    <p style="font-size: 12px">Status Perkawinan</p>
                </td>
                <td>
                    <p style="font-size: 12px">: {{ $surat['self']['status_perkawinan'] }}</p>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <table class="table" style="width: 100%">
        <tbody>
            <tr>
                <td>
                    <p style="font-size: 12px; text-indent: 30px">
                        Nama yang tersebut diatas adalah benar Warga Penduduk Kelurahan Jagalan dan telah terdaftar dalam buku Induk Kependudukan, menurut pendataan kami Pemerintah Kelurahan, Nama yang tersebut adalah Pekerjaan sehari-hari sebagai berikut :
                    </p>
                </td>
            </tr>
        </tbody>
    ...
    <table class="table" style="width: 100%">
        <tbody>
            <tr>
                <td>
                    <p style="font-size: 12px">
                        Usaha tersebut sudah berjalan sejak tahun {{ $surat['self']['sejak'] }} sampai saat ini.
                    </p>
                </td>
            </tr>
        </tbody>
