    ...
    <table class="table" style="width: 100%">
        <tbody>
            <tr>
                <td>
                    <p style="font-size: 12px; text-indent: 30px">
                        Bahwa nama tersebut tercatat sebagai berikut:
                    </p>
                </td>
            </tr>
        </tbody>
    ...
    <table class="table" style="margin-left: 30px;">
        <tbody>
            <tr>
                <td>
                    <p style="font-size: 12px">
                        Kartu Tanda Penduduk dengan nama
                    </p>
                </td>
                <td>
                    <p style="font-size: 12px">
            ...
            <tr>
                <td>
                    <p style="font-size: 12px">
                        {{ $surat['self']['jenisKartu'].__(' dengan nama') }}
                    </p>
                </td>
                <td>
                    <p style="font-size: 12px">
                        : {{ $surat['self']['namaTertera'] }}
                    </p>
                </td>
            </tr>
            <tr>
    ...
    <table class="table" style="width: 100%">
        <tbody>
            <tr>
                <td>
                    <p style="font-size: 12px; text-indent: 30px">
                        Adalah orang yang sama atau bukan orang lain meskipun terjadi perbedaan antara yang tercatat di Kartu Tanda Penduduk dengan {{ $surat['self']['jenisKartu'].__('.') }}
                    </p>
                </td>
            </tr>
        </tbody>
    ...
    <table class="table" style="width: 100%">
        <tbody>
            <tr>
                <td>
                    <p style="font-size: 12px; text-indent: 30px">
                        Demikian surat keterangan ini kami buat dengan sebenarnya untuk dapat dipergunakan seperlunya.
                    </p>
                </td>
            </tr>
        </tbody>
