...
<body>
    ...
    <table class="table" style="margin-left: 30px;">
        <tbody>
            ...
            <tr>
                <td>
                    <p style="font-size: 12px">Nama Orang Tua</p>
                </td>
                <td>
                    <p style="font-size: 12px">: {{ $surat['self']['namaOrangTua'] }}</p>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <table class="table" style="width: 100%">
        <tbody>
            <tr>
                <td>
                    <p style="font-size: 12px; text-indent: 30px">
                        Yang bersangkutan adalah benar-benar warga Kelurahan Jagalan yang berasal dari keluarga kurang mampu.
                    </p>
                </td>
            </tr>
        </tbody>
