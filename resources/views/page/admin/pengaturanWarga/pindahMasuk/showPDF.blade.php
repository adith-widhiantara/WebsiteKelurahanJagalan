...
<head>
    <title>Surat Pindah Masuk</title>
...
<body>
    ...
    <table class="table" style="margin-bottom: 1rem; width: 100%">
        <tbody>
            <tr>
                <td>
                    <h1 style="text-align: center">Surat Keterangan Pindah Masuk</h1>
    ...
    <table class="table" style="width: 100%">
        <tbody>
            <tr>
                <td>
                    <p style="font-size: 12px">Telah pindah masuk :</p>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table" style="margin-left: 30px;">
        <tbody>
            <tr>
                ...
                <td>
                    <p style="font-size: 12px">: {{ $data['pindahMasuk']['alamat'] }}</p>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <p style="font-size: 12px">: {{ $data['pindahMasuk']['tanggal'] }}</p>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <p style="font-size: 12px">: {{ $data['pindahMasuk']['nomor'] }}</p>
                </td>
            </tr>
            @isset($data['pindahMasuk']['keterangan'])
            <tr>
                <td>
                    <p style="font-size: 12px">Keterangan</p>
                </td>
                <td>
                    <p style="font-size: 12px">: {{ $data['pindahMasuk']['keterangan'] }}</p>
                </td>
            </tr>
            @endisset
        </tbody>
    ...
    <table class="table" style="width: 100%">
        <tbody>x
            <tr>
                <td>
                    <p style="font-size: 12px">Demikian surat keterangan pindah masuk ini dibuat untuk dapat digunakan seperlunya.</p>
                </td>
            </tr>
        </tbody>
    </table>
