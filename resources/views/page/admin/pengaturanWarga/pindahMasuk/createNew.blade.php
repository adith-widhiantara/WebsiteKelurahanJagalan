...
@section('breadcrumbs')
{{ Breadcrumbs::render('admin.pindahmasuk.create.new', $kartuKeluarga) }}
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="card card-info">
            ...
            <form action="{{ route('admin.pindahmasuk.store.new', $kartuKeluarga -> nomorkk) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="bs-stepper">
                        ...
                        <div class="bs-stepper-header" role="tablist">
                            ...
                            <div class="step" data-target="#data-diri-part">
                                <button type="button" class="step-trigger" role="tab" aria-controls="data-diri-part" id="data-diri-part-trigger">
                            ...
                            <div class="step" data-target="#pindah-masuk-part">
                                <button type="button" class="step-trigger" role="tab" aria-controls="pindah-masuk-part" id="pindah-masuk-part-trigger">
                                    <span class="bs-stepper-circle">2</span>
                                    <span class="bs-stepper-label">Data Pindah Masuk</span>
                                </button>
                            </div>
                        ...
                        <div class="bs-stepper-content">
                            ...
                            <div id="data-diri-part" class="content" role="tabpanel" aria-labelledby="data-diri-part-trigger">
                            ...
                            <div id="pindah-masuk-part" class="content" role="tabpanel" aria-labelledby="pindah-masuk-part-trigger">

                                <div class="form-group">
                                    <label>Alamat Asal</label>
                                    <input type="text" class="form-control" placeholder="Cth. Jln. Sriwijaya No. 30 Kota Kediri" name="alamat_asal">
                                </div>

                                <div class="form-group">
                                    <label>Tanggal Surat</label>
                                    <div class="input-group date" id="tanggalSuratPindahDatang" data-target-input="nearest">
                                        <div class="input-group-prepend" data-target="#tanggalSuratPindahDatang" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                        </div>
                                        <input type="text" required class="form-control datetimepicker-input" data-target="#tanggalSuratPindahDatang" name="tanggal_surat" value="{{ old('tanggal_surat') }}" />
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label>Nomor Surat</label>
                                    <input type="text" class="form-control" placeholder="Cth. Nomor Surat" name="nomor_surat">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="input-berkas-pindah-masuk" name="file_surat">
                                ...
                                <a class="btn btn-primary" onclick="stepper.previous()">Kembali</a>
...
<script>
    $(function(){
        ...
        $('#tanggalSuratPindahDatang').datetimepicker({
            format: 'YYYY-MM-DD',
            viewMode: 'years'
        });
    });
