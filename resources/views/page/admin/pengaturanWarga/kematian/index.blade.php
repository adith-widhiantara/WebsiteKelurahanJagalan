...
@section('breadcrumbs')
{{ Breadcrumbs::render('admin.kematian.index') }}
@endsection
        ...
        <div class="card card-success">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">
                        Daftar Kematian Warga
                    </h3>
                    <a href="#" class="btn btn-light btn-xs text-dark" data-toggle="modal" data-target="#add-data-kematian">
                        Tambah Data Kematian
                    </a>
                </div>

                <div class="modal fade" id="add-data-kematian">
